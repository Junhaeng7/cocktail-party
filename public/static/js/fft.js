...
/*
 * --Name: Leighton Crawford
 * --Collaborators: N/A
 * --References: https://wavesurfer-js.org/api/file/src/plugin/spectrogram/index.js.html#lineNumber54
 *
 * --Notes: Search for AudioT to see comments/notes on all things that were changed for the fft.js file
 */

/*
 * AudioT Summer Practicum 2021
 * References: https://wavesurfer-js.org/api/file/src/plugin/spectrogram/index.js.html#lineNumber54
 * Comments: 1. Comment out line export default function FFT(bufferSize, sampleRate, windowFunc, alpha) {
             2. Replace with function FFT(bufferSize, sampleRate, windowFunc, alpha) {
 */
