...
var ChonkyPresentationLayer = function ChonkyPresentationLayer(_ref) {
  ...
  var clearSelectionOnOutsideClick = reactRedux.useSelector(selectClearSelectionOnOutsideClick); // Deal with clicks outside of Chonky
...
var useFileClickHandlers = function useFileClickHandlers(file, displayIndex) {
  var dispatch = reactRedux.useDispatch(); // Prepare base handlers
...
var CompactEntry = /*#__PURE__*/React__default.memo( // @ts-ignore
function (_ref) {
  var file = _ref.file,
...
var SmartFileEntry = /*#__PURE__*/React__default.memo(function (_ref) {
  ...
  var dndDisabled = reactRedux.useSelector(selectIsDnDDisabled); // Clickable wrapper properties
